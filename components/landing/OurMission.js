        ...
        <div className="mt-12 mb-2 flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-10 lg:gap-4 w-full">
          {data.map((item, i) => (
            <div
              ...
              <p className="body-small font-light text-center">{item.desc}</p>
            </div>
          ))}
        </div>
      </div>
